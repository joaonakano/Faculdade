...
-- Exercício 1 --
SELECT CONCAT(A.Nome, ' ', A.Sobrenome) as Nome_Completo, E.Logradouro, E.Numero
FROM academia.Pessoa_Associada as A
INNER JOIN academia.Endereco as E
ON E.Endereco_ID = A.Endereco_ID
ORDER BY Nome_Completo ASC;

-- Exercicio 2 --
SELECT CONCAT(A.Nome, ' ', A.Sobrenome) as Nome_Completo, P.Nome_Plano
FROM academia.Pessoa_Associada as A
...
-- Exercício 3 --
SELECT CONCAT(A.Nome, ' ', A.Sobrenome) as Nome_Completo, T.Telefone_Contato , T.Telefone_Emergencia, E.Cep
FROM academia.Pessoa_Associada as A
INNER JOIN academia.Telefone as T
...
-- Exercicio 4 --
SELECT CONCAT(A.Nome, " ", A.Sobrenome) as Nome_Completo, T.Telefone_Contato, E.Cep
FROM academia.Pessoa_Associada as A
INNER JOIN academia.Telefone as T
ON A.Telefone_ID = T.Telefone_ID
INNER JOIN academia.Endereco as E
...
-- Exercicio 5 --
SELECT CONCAT(A.Nome, " ", A.Sobrenome) as Nome_Completo, IFNULL(T.Telefone_Emergencia, "PENDENTE") as Telefone_Emergencia
FROM academia.Pessoa_Associada as A
LEFT JOIN academia.Telefone as T
ON A.Telefone_ID = T.Telefone_ID
ORDER BY Nome_Completo ASC;

-- Exercicio 6 --
SELECT CONCAT(A.Nome, " ", A.Sobrenome) as Nome_Completo, CONCAT(E.Logradouro, ", ", E.Numero, " - ", E.Cep) as Endereco
FROM academia.Pessoa_Associada as A
INNER JOIN academia.Endereco as E
ON A.Endereco_ID = E.Endereco_ID
WHERE A.Endereco_ID IN (
	SELECT A.Endereco_ID
    FROM academia.Pessoa_Associada as A
    GROUP BY A.Endereco_ID
    HAVING COUNT(*) > 1
)
ORDER BY Endereco;

-- Exercicio 7 --
SELECT CONCAT(T.Nome, " ", T.Sobrenome), CONCAT(E.Logradouro, ", ", E.Numero, " - ", E.Cep)
FROM academia.Pessoa_Treinadora as T
INNER JOIN academia.Endereco as E
ON T.Endereco_ID = E.Endereco_ID
WHERE T.Endereco_ID IN (
	SELECT T.Endereco_ID
    FROM academia.Pessoa_Treinadora as T
    GROUP BY T.Endereco_ID
    HAVING COUNT(*) > 1
)
ORDER BY Nome ASC;

-- Exercicio 8 --
SELECT P.Nome_Plano, COUNT(A.Plano_ID) as Pessoas_Inclusas 
FROM academia.Plano as P
INNER JOIN academia.Pessoa_Associada as A
ON A.Plano_ID = P.Plano_ID
GROUP BY P.Nome_Plano, P.Plano_ID;

-- Exercicio 9 --
SELECT CONCAT(A.Nome, " ", A.Sobrenome) as Nome_Completo, H.Periodo
FROM academia.Horario as H
INNER JOIN academia.Treino as T
ON H.Horario_ID = T.Horario_ID
INNER JOIN academia.Pessoa_Associada as A
ON T.Pessoa_Associada_ID = A.Pessoa_Associada_ID
ORDER BY Nome ASC;

-- Exercicio 10 --
SELECT CONCAT(T.Nome, " ", T.Sobrenome) as Nome_Completo, IFNULL(H.Periodo, "LIVRE") as Horario
FROM academia.Pessoa_Treinadora as T
LEFT JOIN academia.Aula as A
ON A.Pessoa_Treinadora_ID = T.Pessoa_Treinadora_ID
